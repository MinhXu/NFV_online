...
public class nGraph {
    ...
    public nGraph(int V,Vector<Vector<Double>> dataReal )
    {
    	this.noV =V;
    	 this.cap = new Vector<Vector<Double>>();
    	this.w= new ArrayList<List<Double>>();
    ...
    public nGraph (int type, int k,int n0,Vector<Vector<Double>> dataReal)//Create FatTree =0, VL2=1, Bcube=2, k is number of servers
    {
    ...
    public nGraph(Vector<Vector<Double>> dataReal) {// 3-tier topology
        int V=30;   
    	this.noV = V;
        this.cap = new Vector<Vector<Double>>();
        this.w= new ArrayList<List<Double>>();
    ...
    public nGraph(Vector<Vector<Double>> K, List<List<Double>> w) 
    {//model newest
    this.noV = K.size();      
	  this.w= new ArrayList<List<Double>>();
    ...
    public int addVertex(Vector<Double> t)//tra ve so dinh cua do thi
    {
    	this.noV = this.noV+1;
    	this.cap.add(t);
    	ArrayList<Boolean> temp1=new ArrayList<>();
